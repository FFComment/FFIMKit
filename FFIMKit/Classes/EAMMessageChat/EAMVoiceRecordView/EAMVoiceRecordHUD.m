...
@implementation EAMVoiceRecordHUD
...
- (void)pauseRecord {
    ...
    self.remindLabel.text = NSLocalizedStringFromTable(@"手指上滑，取消发送", @"MessageDisplayKitString", nil);
}
...
- (void)configRecordingHUDImageWithPeakPower:(CGFloat)peakPower {
    ...
    NSString *path = [FF_BoundlePath ff_imagePathWithName:imageName bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    self.recordingHUDImageView.image = [UIImage imageWithContentsOfFile:path];
}
...
- (void)setup {
    ...
    if (!_remindLabel) {
        ...
        remindLabel.text = NSLocalizedStringFromTable(@"手指上滑，取消发送", @"MessageDisplayKitString", nil);
    ...
    if (!_cutdownLbl) {
        ...
        cutdownLbl.text = NSLocalizedStringFromTable(@"手指上滑，取消发送", @"MessageDisplayKitString", nil);
    ...
    if (!_microPhoneImageView) {
        ...
        NSString *path = [FF_BoundlePath ff_imagePathWithName:@"micro" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        microPhoneImageView.image = [UIImage imageWithContentsOfFile:path];
    ...
    if (!_recordingHUDImageView) {
        ...
        NSString *path = [FF_BoundlePath ff_imagePathWithName:@"RecordingSignal001" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        recordHUDImageView.image = [UIImage imageWithContentsOfFile:path];
    ...
    if (!_cancelRecordImageView) {
        ...
        NSString *path = [FF_BoundlePath ff_imagePathWithName:@"60second" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        cancelRecordImageView.image = [UIImage imageWithContentsOfFile:path];
