...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        NSString *emotion_delete = [FF_BoundlePath ff_imagePathWithName:@"emotion_delete" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        [deleteBtn setImage:[UIImage imageWithContentsOfFile:emotion_delete] forState:UIControlStateNormal];
