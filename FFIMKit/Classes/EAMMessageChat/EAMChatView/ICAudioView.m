...
{
    NSString *luyin = [FF_BoundlePath ff_imagePathWithName:@"luyin" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    UIImageView *imageV = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:luyin]];
    ...
    NSString *kaishianniu = [FF_BoundlePath ff_imagePathWithName:@"kaishianniu" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    [playBtn setBackgroundImage:[UIImage imageWithContentsOfFile:kaishianniu] forState:UIControlStateNormal];
...
- (void)beginPlay:(UIButton *)playBtn
{
    ...
    NSString *zhanting = [FF_BoundlePath ff_imagePathWithName:@"zhanting" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *kaishianniu = [FF_BoundlePath ff_imagePathWithName:@"kaishianniu" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    if (manager.player == nil) {
        [playBtn setBackgroundImage:[UIImage imageWithContentsOfFile:zhanting] forState:UIControlStateNormal];
...
- (void)voiceDidPlayFinished
{
    ...
    NSString *kaishianniu = [FF_BoundlePath ff_imagePathWithName:@"kaishianniu" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    [_playBtn setBackgroundImage:[UIImage imageWithContentsOfFile:kaishianniu] forState:UIControlStateNormal];
}
