 ...
 *  @return 按钮
 */
- (ICEmotionMenuButton *)setupBtn:(NSString *)title buttonType:(ICEmotionMenuButtonType)buttonType
{
    ...
    if ([title isEqualToString:@"Custom"]) {
        NSString *face = [FF_BoundlePath ff_imagePathWithName:@"[鼻涕]" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        [btn setImage:[UIImage imageWithContentsOfFile:face] forState:UIControlStateNormal];
    } else {
