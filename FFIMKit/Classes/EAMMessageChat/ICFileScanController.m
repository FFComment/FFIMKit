...
- (void)makeOtherView
{
    ...
    imageV.image        = [UIImage imageWithContentsOfFile:wenjian];
    [self.view addSubview:imageV];
    ...
    NSString *beijign = [FF_BoundlePath ff_imagePathWithName:@"beijign" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    [openBtn setBackgroundImage:[UIImage imageWithContentsOfFile:beijign] forState:UIControlStateNormal];
