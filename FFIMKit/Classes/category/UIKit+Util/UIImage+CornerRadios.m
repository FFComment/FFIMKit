//
//  UIImage+CornerRadios.m
//  edu_anhui_util
//
//  Created by yangjuanping on 2017/5/26.
//
//

#import "UIImage+CornerRadios.h"

@implementation UIImage (CornerRadios)
// 自定义裁剪算法
- (UIImage *)dealImageWithCorner:(CGFloat)radius {
    ...
    cornerImage(imgData, width, height, radius*2);
