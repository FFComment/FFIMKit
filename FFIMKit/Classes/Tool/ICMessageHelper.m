...
{
    NSString *yinpin = [FF_BoundlePath ff_imagePathWithName:@"yinpin" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *shipin = [FF_BoundlePath ff_imagePathWithName:@"shipin" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *pdf = [FF_BoundlePath ff_imagePathWithName:@"pdf" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *word = [FF_BoundlePath ff_imagePathWithName:@"word" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *excerl = [FF_BoundlePath ff_imagePathWithName:@"excerl" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *ppt = [FF_BoundlePath ff_imagePathWithName:@"ppt" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *zhaopian = [FF_BoundlePath ff_imagePathWithName:@"zhaopian" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *txt = [FF_BoundlePath ff_imagePathWithName:@"txt" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    NSString *wenjian = [FF_BoundlePath ff_imagePathWithName:@"wenjian" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    switch (type) {
        case ICFileType_Audio:
            return [UIImage imageWithContentsOfFile:yinpin];
            break;
        case ICFileType_Video:
            return [UIImage imageWithContentsOfFile:shipin];
            break;
        case ICFileType_Html:
            return [UIImage imageNamed:@"html"];
            break;
        case ICFileType_Pdf:
            return  [UIImage imageWithContentsOfFile:pdf];
            break;
        case ICFileType_Doc:
            return  [UIImage imageWithContentsOfFile:word];
            break;
        case ICFileType_Xls:
            return [UIImage imageWithContentsOfFile:excerl];
            break;
        case ICFileType_Ppt:
            return [UIImage imageWithContentsOfFile:ppt];
            break;
        case ICFileType_Img:
            return [UIImage imageWithContentsOfFile:zhaopian];
            break;
        case ICFileType_Txt:
            return [UIImage imageWithContentsOfFile:txt];
            break;
        default:
            return [UIImage imageWithContentsOfFile:wenjian];
            break;
    }
}
