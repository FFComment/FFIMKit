...
+ (instancetype)sharedManager
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *album_picture_fail_big = [FF_BoundlePath ff_imagePathWithName:@"album_picture_fail_big" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
        _failedImage  = [UIImage imageWithContentsOfFile:album_picture_fail_big];
    });
    return _instance;
}
                                  ...
                                  isSender:(BOOL)isSender
{
    ...
    NSString *video_play_btn_bg = [FF_BoundlePath ff_imagePathWithName:@"video_play_btn_bg" bundle:@"FFIMKit" targetClass:[self class] oftype:@"png"];
    if (videoImg) {
        UIImage *addImage = [UIImage addImage2:[UIImage imageWithContentsOfFile:video_play_btn_bg] toImage:videoImg];
    ...
    UIImage *resultImg = [UIImage addImage2:[UIImage imageWithContentsOfFile:video_play_btn_bg] toImage:videoArrowImage];
    if (resultImg) {
